...
function logoB_W() {
  return (
    <div
      ...
      data-animation-identifier="sync"
      style={{}}
    >
      <div className="inner-wrap">
        <div
          className="animation"
          data-animation-config='{"name":"sync","fps":25,"background":"#ffffff","foreground":["#222223"]}'
          ...
          >
            <g
              style={{
                mixBlendMode: "normal",
                WebkitTransition:
                  "fill-opacity 1200ms linear 0s, stroke-opacity 1200ms 0s",
                transition:
                  "fill-opacity 1200ms linear 0s, stroke-opacity 1200ms 0s",
              }}
            >
